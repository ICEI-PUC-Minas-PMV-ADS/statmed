...
|  Tarefa  | Descrição  | Testador|
| ------------ | ------------ | ------------ |
|  T007 | Criar uma anamnese  | Usuário 2 |

|  Pergunta  | Descrição  |
| ------------ | ------------ |
|  P001 | Qual foi o tempo de resposta do sistema ápos clicar para realizar o processo solicitado? |
|**Resposta**| **85ms**
|  P002 | Em sua opinião, os passos para realizar esse processo foi intuitivo? |
|**Resposta**| **Sim, o passo foi bem tranquilo de seguir**|
|  P003 | O sistema foi responsivo em seu dispostivo? |
...
|  Tarefa  | Descrição  | Testador|
| ------------ | ------------ | ------------ |
|  T008 | Solicitar ajuda na tela de login  | Usuário 3 |
...
|**Resposta**| **Felizmente não**
|  P008 | Em sua opinião, o sistema facilitaria alguma atividade na sua rotina de trabalho? |
|**Resposta**| **Sim, nos ajudaria muito quando ficassémos com alguma duvida sobre o login** |

|  Tarefa  | Descrição  | Testador|
| ------------ | ------------ | ------------ |
|  T008 | Gerar Atestado  | Usuário 3 |
...
|**Resposta**| **Felizmente não**
|  P008 | Em sua opinião, o sistema facilitaria alguma atividade na sua rotina de trabalho? |
|**Resposta**| **Sim, muito melhor por questão de padronização** |

|  Tarefa  | Descrição  | Testador|
| ------------ | ------------ | ------------ |
|  T010 | Gerar Receituario | Usuário 3 |
